...
def r_or_c_or_else(argv : list) -> str:
    retour = ""
    try:
...
def project_parameter() -> str:
    return "Projet : lpgcdm-0"

def authors_parameter() -> str:
    return "Samuel Placek" + "\n" + "Gabriel Gasnier"

def verbose_parameter() -> str:
    return project_parameter() + "\n" + authors_parameter()

def help_parameter() -> str:
...
def print_solved_map(map: list) -> list:
    coordonates = find_carre(map)
